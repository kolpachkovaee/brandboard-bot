...
@dp.message(StateFilter(Brief.brand_name))
async def h01(m, s): await handle_answer(m, s, Brief.brand_name)
@dp.message(StateFilter(Brief.brand_sphere))
async def h02(m, s): await handle_answer(m, s, Brief.brand_sphere)
@dp.message(StateFilter(Brief.brand_product))
async def h03(m, s): await handle_answer(m, s, Brief.brand_product)
@dp.message(StateFilter(Brief.brand_mission))
async def h04(m, s): await handle_answer(m, s, Brief.brand_mission)
@dp.message(StateFilter(Brief.brand_values))
async def h05(m, s): await handle_answer(m, s, Brief.brand_values)
@dp.message(StateFilter(Brief.brand_story))
async def h06(m, s): await handle_answer(m, s, Brief.brand_story)
@dp.message(StateFilter(Brief.audience_who))
async def h07(m, s): await handle_answer(m, s, Brief.audience_who)
@dp.message(StateFilter(Brief.audience_pain))
async def h08(m, s): await handle_answer(m, s, Brief.audience_pain)
@dp.message(StateFilter(Brief.audience_desire))
async def h09(m, s): await handle_answer(m, s, Brief.audience_desire)
@dp.message(StateFilter(Brief.competitors_who))
async def h10(m, s): await handle_answer(m, s, Brief.competitors_who)
@dp.message(StateFilter(Brief.competitors_diff))
async def h11(m, s): await handle_answer(m, s, Brief.competitors_diff)
@dp.message(StateFilter(Brief.visual_like))
async def h12(m, s): await handle_answer(m, s, Brief.visual_like)
@dp.message(StateFilter(Brief.visual_dislike))
async def h13(m, s): await handle_answer(m, s, Brief.visual_dislike)
@dp.message(StateFilter(Brief.visual_mood))
async def h14(m, s): await handle_answer(m, s, Brief.visual_mood)
@dp.message(StateFilter(Brief.visual_style))
async def h15(m, s): await handle_answer(m, s, Brief.visual_style)
@dp.message(StateFilter(Brief.assoc_words))
async def h16(m, s): await handle_answer(m, s, Brief.assoc_words)
@dp.message(StateFilter(Brief.assoc_person))
async def h17(m, s): await handle_answer(m, s, Brief.assoc_person)
@dp.message(StateFilter(Brief.assoc_place))
async def h18(m, s): await handle_answer(m, s, Brief.assoc_place)
@dp.message(StateFilter(Brief.assoc_feeling))
async def h19(m, s): await handle_answer(m, s, Brief.assoc_feeling)
@dp.message(StateFilter(Brief.extra_notes))
async def h20(m, s): await handle_answer(m, s, Brief.extra_notes)
